...
type_writer_anim("Hello and welcome to Crypto-Bot\n Crypto-Bot, is a Chat-Bot made with Jina to ans your Crypto related question and even teach you python while you are at it \n")
...
while True:
    questions = [ 
        inquirer.List(
            'ans',
            message = 'Menu',
            choices = ['Start Chatting', 'About Crypto-Bot', 'Quit'],
        )
    ]
    ...
    elif ans['ans'] == 'About Crypto-Bot':
        text = """Hello and welcome to Crypto-Bot. \n Crypto-Bot, is a Chat-Bot made with Jina to ans your Crypto and python related questions \n The datafile has over 150 questions scraped from best possible sources to help you in your autmation journey \n """
