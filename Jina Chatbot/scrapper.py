def guru():
    ...
    raw_reponse = response.html.find(
        "#g-mainbar > div:nth-child(1) > div > div > div > div > div > div:nth-child(3)",
        first=True,
    ).text
...
def win():
    sel = "#loadmore"
    url = "https://www.wisdomjobs.com/e-university/blockchain-interview-questions.html"
    from requests_html import HTMLSession
...
def win2():
    url = "https://www.geeksforgeeks.org/15-commonly-asked-blockchain-interview-questions-answers/"
    from requests_html import HTMLSession
